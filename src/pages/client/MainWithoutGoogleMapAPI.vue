...
const accessToken = ref("pk.eyJ1IjoiYmpjcm9jazEwIiwiYSI6ImNtNXhrNTdibDBhYnQyam9ueWJmaDJ3ajYifQ.9LV1zKsB1AWBtrDaQdxCEA") // Replace with your Mapbox token
const dataQuery = ref([])
...
const onSearchInput = async () =>{
    ...
    timeout.value = setTimeout(async () =>{
      ...
      const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(
        searchQuery.value
      )}.json?access_token=${accessToken.value}&autocomplete=true`;
...
const selectSuggestion = (suggestion:any) => {
    ...
    formClient.longitude = suggestion.geometry.coordinates[0]
    formClient.latitude = suggestion.geometry.coordinates[1]
    suggestions.value = []
    selectedLocation.value = extractLocationDetails(suggestion.context)
    console.log("Selected suggestion:", suggestion);
}
const extractLocationDetails = (context:any) =>{
  const locationsDetails = {
    city:  getContextValue(context,"place"),
    barangay: getContextValue(context,"barangay"),
    province: getContextValue(context,"province")
  };
  return locationsDetails
}
const getContextValue = (context:any, type:any) => {
                          ...
                          <div class="col-span-12 sm:col-span-6">
                            <div class="col-span-12 sm:col-span-3">
                              ...
                              <div v-if="selectedLocation">
                                ...
                                <p><strong>Barangay:</strong> {{ selectedLocation.barangay }}</p>
