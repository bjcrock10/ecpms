...
interface AutoCompleteProps extends /* @vue-ignore */ InputHTMLAttributes {
...
const computedClass = computed(() =>
  twMerge([
    "w-full disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent",
...
const emit = defineEmits<AutoCompleteEmit>();
