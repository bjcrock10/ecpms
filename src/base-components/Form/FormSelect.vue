...
const computedClass = computed(() =>
  twMerge([
    ...
    "transition duration-200 ease-in-out w-full text-sm border-slate-400 shadow-sm rounded-md py-2 px-3 pr-8 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50",
